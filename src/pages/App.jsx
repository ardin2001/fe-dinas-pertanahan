    ...
    <div className='grid h-screen bg-gray-200'>
      <div className='grid grid-flow-col grid-cols-2 m-12 drop-shadow-custom-login'>
        ...
        <div className='grid bg-white items-center justify-items-center border-y-2 border-green-500 border-r-2'>
          <form onSubmit={handlerLogin} className='w-7/12 grid gap-4 px-10 py-3 rounded-md'>
            ...
            <button type='submit' className='bg-green-500 w-1/2 justify-self-center h-7 font-semibold'>Login</button>
          </form>
        </div>
      </div>
    </div>
