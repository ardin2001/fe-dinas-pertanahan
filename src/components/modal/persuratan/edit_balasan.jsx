...
const ModalEditBalasan = (props) => {
  ...
  return (
    <div className="fixed bg-white rounded-lg drop-shadow-custom z-50 inset-x-2/10 inset-y-1/10 px-8 py-4 grid grid-rows-6">
      ...
      <div className="button grid gap-8 grid-flow-col text-white font-semibold text-center w-1/3 justify-self-end items-end row-start-5 row-end-7">
        <div className="grid grid-flow-col gap-2 items-center py-1 bg-custom rounded-lg">
          <p>Batal</p>
        </div>
